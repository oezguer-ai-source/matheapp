...
**Plans**: 9 plans
**Plan list**:
- [ ] 10-01-PLAN.md — Supabase cloud project + .env.local env-var contract (checkpoint)
- [ ] 10-02-PLAN.md — Next.js 15.2 scaffolding + shadcn/ui init + route groups
- [ ] 10-03-PLAN.md — Vitest + Playwright Wave-0 infrastructure (all test files scaffolded)
...
- [ ] 10-08-PLAN.md — Next.js middleware.ts + stub /kind/dashboard + /lehrer/dashboard
...
|-------|---------------|--------|-----------|
| 10. Foundation | 0/TBD | Not started | - |
